            ...
            <>
              ...
              >
                ...
                {!isCollapsed[index] && (
                  <>
                    <div className="my-3">
                      <label className={style.lable}>Video Title</label>
                      <input
                        type="text"
                    ...
                    <div className="mb-3">
                      <label className={style.lable}>Video Url</label>
                      <input
                        type="text"
                        placeholder="sdder"
                        className={`${style.input}`}
                    ...
                    <div className="mb-3">
                      <label className={style.lable}>Video Length (in minutes)</label>
                      <input
                        type="number"
                        placeholder="20"
                        className={`${style.input}`}
                    ...
                    <div className="mb-3">
                      <label className={style.lable}>Video Description</label>
                      <textarea
                        rows={8}
                        cols={30}
                        placeholder="sdder"
